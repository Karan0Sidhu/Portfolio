...
const handleChatSubmit = async (e) => {
  ...
  // In development, hit your local express server. In production on Netlify, hit the relative /api/ path.
...
const projects = [
    {
      ...
      description: 'Led the development of a text mining chatbot for the Bioin 401 project & research internship, focused on extracting structured knowledge from scientific literature. Designed a robust pipeline to extract subject–predicate–object triplets from research articles, enhancing the accuracy of the chatbot\'s knowledge graph. Created high-quality datasets and introduced a system of "bonus positives" to capture valid but previously overlooked predictions, improving the reliability of evaluation metrics. Automated the quantitative evaluation process, significantly boosting the consistency and accuracy of model assessment.',
    ...
    },
    {
      ...
      description: 'Developed a lightweight, cost-effective alternative to AppSignal for performance monitoring and error tracking in multi-server environments. The project automated log analysis over SSH, enabling real-time anomaly detection and proactive alerts via email. Designed for scalability, it delivered comprehensive monitoring capabilities without the overhead of commercial solutions.',
    ...
    },
    {
      ...
      description: 'Designed and developed an Android-based event management app using Android Studio and Firebase, streamlining check-ins for attendees, organizers, and administrators. Implemented QR code generation and scanning features integrated with real-time database operations to support efficient event workflows. Enabled multi-user access control, allowing organizers to manage attendees and admins to oversee and moderate content. Managed development through agile cycles using GitHub Projects, ensuring timely and structured delivery of key features.',
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      {/* Hero Section */}
      <HeroSection jobTitles={jobTitles} />
      {/* Skills Section */}
      ...
      {/* Chatbot Section */}
      {/*false &&(  left side is just hiding this  */}
      <ChatbotSection
        StartChat={StartChat}
        ...
        loading={loading}
      />
     { /* right side is just hiding above  )*/}
